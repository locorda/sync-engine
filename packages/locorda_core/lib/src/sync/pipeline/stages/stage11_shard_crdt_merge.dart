...
///
/// **Input**: `Stream<LoadedShardEntries | PhaseComplete>`
/// **Output**: `Stream<MergedShard | PhaseComplete>`
library;
...
Stream<Object> Function(Object) shardCrdtMerge(
  ...
  return (Object event) async* {
    ...
    final loaded = event as LoadedShardEntries;
