/// Main-thread bridge for Drift storage settings in worker architecture.
library;
...
/// Worker plugin that bridges Drift storage settings from main thread to worker.
class DriftConfigConnector {
  ...
  static MainHandlerFactory sender(LocordaDriftOptions options, String id) {
