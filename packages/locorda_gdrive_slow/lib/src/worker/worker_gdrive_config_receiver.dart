...
/// Worker-side receiver for [GDriveSlowConfig].
///
...
class WorkerGDriveConfigReceiver {
  ...
  final Completer<GDriveSlowConfig> _configCompleter = Completer();
  ...
  Future<GDriveSlowConfig> getConfig() => _configCompleter.future;
