...
class GDriveAuthConnector {
  ...
  ///
  /// Call this in the worker entry point to create a [GDriveSlowAuthProvider]
  ...
  /// }
  /// ```
  static GDriveSlowAuthProvider receiver(WorkerHandlerContext context) {
    return WorkerGDriveAuthProvider(
        context.createChannel('locorda_gdrive_slow/gdrive_auth'));
  }

  /// Creates config receiver for worker context.
  ///
  /// Call this in the worker entry point to receive [GDriveSlowConfig]
  ...
  /// }
  /// ```
  static Future<GDriveSlowConfig> receiveConfig(WorkerHandlerContext context) {
    final receiver = WorkerGDriveConfigReceiver(
        context.createChannel('locorda_gdrive_slow/gdrive_config'));
