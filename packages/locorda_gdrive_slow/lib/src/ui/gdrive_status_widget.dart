...
import 'package:locorda_gdrive_slow/src/ui/gdrive_status_defaults.dart';
...
/// )
/// ```
class GDriveSlowStatusWidget extends LocordaStatusWidget {
  GDriveSlowStatusWidget({
    super.key,
    ...
    super.onShowStatusMenu,
            ...
            onShowLogin: onShowLogin ??
                GDriveSlowStatusDefaults.modalLogin(gdriveAuth: gdriveAuth),
            auth: gdriveAuth);
}
