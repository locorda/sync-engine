...
///
/// Uses [GDriveSlowAuth] to initiate OAuth2 flow.
typedef GDriveSignInCallback = Future<bool> Function();

class GDriveSlowLoginScreen extends StatefulWidget {
  final GDriveSignInCallback onSignIn;

  const GDriveSlowLoginScreen({
    super.key,
    required this.onSignIn,
  });

  @override
  State<GDriveSlowLoginScreen> createState() => _GDriveSlowLoginScreenState();
}

class _GDriveSlowLoginScreenState extends State<GDriveSlowLoginScreen> {
