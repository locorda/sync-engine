...
import 'package:locorda_gdrive_slow/l10n/gdrive_localizations.dart';
import 'package:locorda_gdrive_slow/src/gdrive_auth.dart';
...
class GDriveSlowStatusDefaults {
  GDriveSlowStatusDefaults._(); // Private constructor - utility class

  /// Default login flow showing [GDriveSlowLoginScreen] as modal dialog.
  ///
  /// This is a factory function that returns a login callback configured
  /// for the specific auth instance.
  ///
  /// Returns a callback that:
  /// 1. Shows [GDriveSlowLoginScreen] as a full-screen dialog
  ...
  static Future<bool> Function(BuildContext) modalLogin({
    ...
    return (BuildContext context) async {
      ...
      final user = await Navigator.of(context).push<bool>(
        MaterialPageRoute(
          builder: (context) =>
              GDriveSlowLoginScreen(onSignIn: gdriveAuth.authenticate),
