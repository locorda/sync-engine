...
///
/// This connector:
/// 1. Listens to [GDriveSlowAuth.isAuthenticatedNotifier] for state changes
...
class GDriveAuthConnector {
  ...
  static MainHandlerFactory sender(GDriveSlowAuthProvider authBridge) {
    return (MainHandlerContext context) {
      return GDriveAuthSender(
        authBridge: authBridge,
        workerHandle: context.createChannel('locorda_gdrive_slow/gdrive_auth'),
      );
    };
  }
}
