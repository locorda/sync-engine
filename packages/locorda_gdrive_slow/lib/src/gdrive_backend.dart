...
class GDriveClient {
  ...
  factory GDriveClient(
      {required GDriveSlowAuthProvider authProvider, RdfCore? rdfCore}) {
  ...
  ///
  /// Throws [GDriveSlowClientException] if user not authenticated or API error occurs.
  Future<String> getOrCreateFolder({
    ...
    try {
      ...
      throw GDriveSlowClientException(
  ...
  Future<({String fileId, String etag})> createFile(
    ...
    try {
      ...
      throw GDriveSlowClientException('Failed to create file "$filename": $e');
    }
  }
  ...
  Future<String?> findFile({
    ...
    try {
      ...
      throw GDriveSlowClientException('Failed to find file "$fileName": $e');
    }
  }
  ...
  Future<({RdfGraph? graph, String? etag, bool notModified})> download(
    ...
    try {
      ...
      throw GDriveSlowClientException('Failed to download file $fileId: $e');
    }
  }
  ...
  Future<RemoteUploadResult> upload(String fileId, RdfGraph updatedGraph,
    ...
    try {
      ...
      if (e.status == 404) {
        ...
        throw GDriveSlowClientException('File not found: $fileId');
      }
      ...
      throw GDriveSlowClientException('Failed to upload file $fileId: $e');
    }
  }
...
class _GoogleAuthClient extends http.BaseClient {
  final GDriveSlowAuthProvider _authProvider;
...
class GDriveSlowClientException implements Exception {
  final String message;
  GDriveSlowClientException(this.message);
...
class GDriveBackend implements Backend {
  ...
  final GDriveSlowAuthProvider _auth;
  final GDriveClient _client;
  final GDriveTypeIndexManager _typeIndexManager;
  final ResourceLocator _resourceLocator;
  ...
  factory GDriveBackend({
    required GDriveSlowAuthProvider auth,
  ...
  void _authStateChanged() {
    ...
    if (_auth.isAuthenticatedNotifier.isAuthenticated) {
      ...
      final spaces = _config.folderMode == GDriveSlowFolderMode.appDataFolder
          ? 'appDataFolder'
          : 'drive';
